...
import pylab as plt
ArticlesMB="""A year after his controversial profanity-filled public remarks, President Duterte has sent a letter to Pope Francis to assure his deep respect for the pontiff and affirms the country’s “special relations” with the Vatican.
...
G=nx.DiGraph()
wordsArticles = word_tokenize(ArticlesMB)
